...
public class ClientMain {
	...
	public static void main(String[] args) {
		...
		try {
			...
			SHServiceClientM shServiceClient2 = new SHServiceClientM(2, 2, 2, Color.CYAN, shServiceClientV2, serverHostAdress, serverPort);
			SHServiceClientM shServiceClient3 = new SHServiceClientM(3, 4, 6, Color.ORANGE, shServiceClientV3, serverHostAdress, serverPort);
